#ifndef NV2A_TRACE_NTRC_DDXT_CIRCULAR_BUFFER_H_
#define NV2A_TRACE_NTRC_DDXT_CIRCULAR_BUFFER_H_
...
// and its contents.
CircularBuffer CBCreateEx(uint32_t size, CBAllocProc alloc_proc, CBFreeProc free_proc);
...
uint32_t CBWriteAvailable(CircularBuffer handle, const void *data, uint32_t max_size);
...
uint32_t CBReadAvailable(CircularBuffer handle, void *buffer, uint32_t max_size);

#ifdef __cplusplus
};  // extern "C"
#endif

#endif  // NV2A_TRACE_NTRC_DDXT_CIRCULAR_BUFFER_H_
